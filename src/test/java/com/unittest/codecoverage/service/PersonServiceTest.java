...
public class PersonServiceTest {
	...
	public void testInsert_shouldThrowPersonExceptionWhenPersonAgeIsZero() {

		List<String> expectedErrors = Lists.newArrayList("Age is required");
		String expectedMessage = String.join(";", expectedErrors);
		Person person = new Person();
	...
	@Test
	public void testupdate_shouldNeverUpdatewhenpersonnameisnull(){
		List<String> expectedErrors = Lists.newArrayList("Name is required");
		String expectedMessage = String.join(";", expectedErrors);
		Person person = new Person();
		person.setName(null);
	...
	@Test
	public void testinsert_shouldNeverUpdatewhenpersonisnull(){
		List<String> expectedErrors = Lists.newArrayList("person is required");
		String expectedMessage = String.join(";", expectedErrors);
		Person person ;
		person= null;
